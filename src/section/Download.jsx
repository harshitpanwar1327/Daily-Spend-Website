...
const Download = () => {
  return (
    <Element name="download" className='h-[80vh] bg-[url(/src//assets/download-bg.jpg)] bg-center bg-cover mb-16 mx-8 rounded-lg grid grid-cols-1 lg:grid-cols-3 place-items-center'>
